                      ...
                      <tbody>
                        <tr>
                          ...
                          <td
                            ...
                            width="20%"
                          >
                            <table border="0" cellpadding="0" cellspacing="0" className="main_header_info">
                              <tr>
                                <td>
                              ...
                              <tr>
                                ...
                                <td>{singleOrderDetail?.createdAt ? dateFormatter(singleOrderDetail.createdAt, "getInIso") : ""}</td>
                              </tr>
                              <tr>
                                <td>
            ...
            {/* For Mozilla First page blank Issue solved add new class at first tbody */}
              <tr>
                <td>
                  ...
                  >
                    <tr>
                      <td align="right">Status : {singleOrderDetail?.OrderStatus}</td>
                    </tr>
                  </table>
                  <table
                    border="0"
                  ...
                  >
                    ...
                    <tr>
                      <td>
                        ...
                        City – State
                        <br />
                        Country - {singleOrderDetail?.Supplier?.ZipCode} <br />
                      ...
                      <td>
                        <strong>{singleOrderDetail?.Customer_Address?.Title}</strong>
                        <br />
                        {singleOrderDetail?.Customer_Address?.Address}
                        <br />
                        delivery_city – delivery_state
                        <br />
                        delivery_country - {singleOrderDetail?.Customer_Address?.ZipCode}
                        <br />
                        <strong>Phone : </strong>{singleOrderDetail?.Customer_Address?.Phone}
                        <br />
                        <strong>Email : </strong>{singleOrderDetail?.Customer?.Email}
                        <br />
                  ...
                  >
                    ...
                    <tbody>
                      {productArr.length > 0 && productArr.map((item, index) => {
                        ...
                        return <>
                        <PurchaseOrderProductList item={item} index={index} />
                        </>
                    ...
                    <tbody>
                      <tr className="">
                        ...
                        <td width="15%" align="right" className="total_value">
                          <strong>{breakupDetails?.subTotal}</strong>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr className="">
                        ...
                        <td width="15%" align="right" className="total_value">
                          <strong>{breakupDetails.grandTotal}</strong>
                        </td>
                      </tr>
                      <tr>
                        <td width="" align="right" className=""></td>
